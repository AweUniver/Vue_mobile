...
export const userUnFollowedAPI = ({ userId }) =>
  request({
    url: `/v1_0/user/followings/:target${userId}`,
    method: 'DELETE'
  })
// 获取所有频道
...
// 文章-反馈垃圾内容
export const reportArticleAPI = ({ artId }) =>
  request({
  ...
  // 对文章点赞
export const likeArticleAPI = ({ artId, type }) =>
  request({
    url: '/v1_0/article/likings',
    method: 'POST'
  })
// 取消对文章点赞
export const unLikeArticleAPI = ({ artId, type }) =>
  request({
