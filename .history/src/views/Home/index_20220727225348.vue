<template>
  <div>
    ...
    <van-popup class="channel_popup" v-model="show" get-container="body"
      ><channel-edit :userList="userChannelList" :unCheckList="unCheckChannelList"></channel-edit
    ></van-popup>
  </div>
</template>
...
export default {
  ...
  computed: {
    ...
    //   })
    //   return newArr
      return this.allChannelList.filter(bigObj => (this.userChannelList.findIndex(smallObj.id === bigObj.id) === -1))
    }
  }
}
</script>
