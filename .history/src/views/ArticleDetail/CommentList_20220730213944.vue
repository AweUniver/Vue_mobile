...
<script>
import { commentsListAPI, commentLikingAPI, commentDisLikingAPI, commentsSendAPI } from '@/api'
...
export default {
  ...
  methods: {
    ...
    async sendFn () {
      const res = commentsSendAPI({
        id: this.$route.query.art_id,
        content: this.content
      })
      res.data.data.new_obj
    },
    // 输入框失去焦点
    blurFn () {
      setTimeout(() => {
