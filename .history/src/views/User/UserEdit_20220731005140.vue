  ...
  <div class="user-edit-container">
    ...
    <van-cell-group class="action-card">
      ...
      <van-cell
        ...
        @click="nameClickFn"
      />
      <van-cell title="生日" is-link :value="profileObj.birthday" @click="dateTimePickerShow=true"/>
    </van-cell-group>
    <!-- 姓名修改弹窗 -->
    <van-dialog
      v-model="show"
    ...
    <!-- 时间选择器 -->
    <van-popup v-model="dateTimePickerShow" position="bottom" :style="{ height: '50%' }" round>
    <van-datetime-picker
      v-model="currentDate"
      type="date"
      title="选择年月日"
